...
export function GoalTreeNode(props) {
    return (
        <View style={{alignSelf: 'center'}}>
            ...
            <Pressable onPress={() => props.setTimeboxView({data: props.goal, open: true})} style={{backgroundColor: styles.primaryColor, maxWidth: '80%', paddingHorizontal: '10%', paddingVertical: '5%'}}>
